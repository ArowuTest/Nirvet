...
**→ M-1 remediated; awaiting reviewer re-verify (folded into pre-go-live pass 1). Four-eyes on account-suspend: reviewer confirmed NOT required for a reversible keep-protecting suspension (line is by consequence, not blast radius; reserve four-eyes for a go-dark escalation).**
