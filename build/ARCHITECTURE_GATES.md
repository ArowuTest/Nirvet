...
**→ M-1 + follow-on High both remediated; awaiting reviewer re-verify of 355e34c (slice-B clearance held until clean). Four-eyes on account-suspend: reviewer confirmed NOT required for a reversible keep-protecting suspension (line is by consequence, not blast radius; reserve four-eyes for a go-dark escalation).**
